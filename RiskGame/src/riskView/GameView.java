...
public class GameView extends JDialog {
    ...
    private JPanel messagePanel() {
        ...
        countryAListModel = new GameListModel(serviceLayer, "countryA");
        countryBListModel = new GameListModel(serviceLayer, "countryB");

        serviceLayer.addObserver((GameListModel) countryAListModel);
        serviceLayer.addObserver((GameListModel) countryBListModel);
