...
public class CreateMap {
	...
	public static void main(String args[])
	{
		...
		System.out.println("Continent names are");for(String continent :continentNameList) {System.out.print(continent+" ");}System.out.println("");
		System.out.println("Country names are ");for(String country :countryNameList) {System.out.print(country+" ");}System.out.println("");
		int counter=0;
